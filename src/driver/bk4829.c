...
static void RF_SetAfResponse_TX(uint8_t f3k, uint8_t db) {
  uint16_t d1 = 0;
  uint16_t d2 = 0;
  ...
  case 0:        // 300Hz
    ...
    BK4819_WriteRegister(0x44, d1);
    BK4819_WriteRegister(0x45, d2);
    break;
  }
}

static void RF_SetAfResponse_RX(uint8_t f3k, uint8_t db) {
  uint16_t d1 = 0;
  uint16_t d2 = 0;
